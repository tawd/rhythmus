...
//TASKS FOR NEXT WEDNESDAY
// - Clean up code - no printing just returning
...
class Milestonia extends Abstract_Endpoint {
	...
	public function register_routes() {
		...
		$this->register_route( $milestonia_route, array(
			array(
	...
	public function get_user_email( $teammate_id ) {
		...
		$query = $wpdb->prepare("SELECT u.user_email,t.fname,t.lname
		FROM wp_users u 
